...
using Test.Dotnet.Topic.Ai.Api.AutoMapper;
using Test.Dotnet.Topic.Ai.Api.Config;
using Test.Dotnet.Topic.Ai.Api.Extensions;
...
namespace Test.Dotnet.Topic.Ai.Api;
...
public static class Program
{
    ...
    public static void ConfigureServices(WebApplicationBuilder builder)
    {
        ...
        {
            config.SwaggerDoc("v1", new OpenApiInfo { Title = "Test.Dotnet.Topic.Ai", Version = "v1" });
        });
