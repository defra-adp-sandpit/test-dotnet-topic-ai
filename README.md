...
test-dotnet-topic-ai Dotnet service.
...
`docker-compose -p test-dotnet-topic-ai-test -f docker-compose.yaml -f docker-compose.test.yaml up`
...
`docker-compose -p test-dotnet-topic-ai-test -f docker-compose.yaml -f docker-compose.test.watch.yaml up`
...
```
variableGroups:
    - test-dotnet-topic-ai-snd1
    - test-dotnet-topic-ai-snd2
    - test-dotnet-topic-ai-snd3
variables:
    - test-dotnet-topic-ai-APPLICATION-SECRET
```
